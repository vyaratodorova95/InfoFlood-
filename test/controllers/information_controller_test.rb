...
class InformationControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create information" do
    assert_difference('Information.count') do
      post information_index_url, params: { information: { began: @information.began, country_id: @information.country_id, dead: @information.dead, displaced: @information.displaced, ended: @information.ended, maincause: @information.maincause, validation: @information.validation } }
    end
  ...
  test "should update information" do
    patch information_url(@information), params: { information: { began: @information.began, country_id: @information.country_id, dead: @information.dead, displaced: @information.displaced, ended: @information.ended, maincause: @information.maincause, validation: @information.validation } }
