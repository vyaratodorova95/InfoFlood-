class InformationController < ApplicationController
  ...
  rescue_from ActiveRecord::RecordNotFound, with: :redirect_if_information_not_found
  ...
  private
    ...
    def information_params
      params.require(:information).permit(:began, :ended, :validation, :dead, :displaced, :maincause, :country_id)
    end
end
